...
load_pth = os.path.dirname(os.path.abspath(__file__)) + "/actor_850.pth"
agent = RLAgent(state_shape, continue_space)
agent.load_model(load_pth)
# agent.save_model(load_pth)
action_num = 36
discrete_space = Discrete(action_num)
load_path2 = os.path.dirname(os.path.abspath(__file__)) + "/actor_2250.pth"
